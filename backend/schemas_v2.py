...
class PublicSurveySubmissionRequest(BaseModel):
    ...
    usage_probability: int = Field(default=4, ge=1, le=5)
    launch_readiness: str = Field(default="lanzar_con_cautela", min_length=2, max_length=80)
    advertising_confidence: str = Field(default="con_cautela", min_length=2, max_length=80)
    would_pay: str = Field(min_length=2, max_length=60)
    failures: str | None = Field(default=None, max_length=3000)
