...
ALTER TABLE casos ADD COLUMN IF NOT EXISTS case_route TEXT;
ALTER TABLE casos ADD COLUMN IF NOT EXISTS viability_level TEXT;
ALTER TABLE casos ADD COLUMN IF NOT EXISTS urgency_level TEXT;
ALTER TABLE casos ADD COLUMN IF NOT EXISTS requires_human_review BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE casos ADD COLUMN IF NOT EXISTS dx_result JSONB NOT NULL DEFAULT '{}'::JSONB;
ALTER TABLE casos ADD COLUMN IF NOT EXISTS source_validation JSONB NOT NULL DEFAULT '{}'::JSONB;
ALTER TABLE casos ADD COLUMN IF NOT EXISTS final_validation JSONB NOT NULL DEFAULT '{}'::JSONB;
...
CREATE TABLE IF NOT EXISTS case_stage_outputs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    case_id UUID NOT NULL REFERENCES casos(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS case_pending_questions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    case_id UUID NOT NULL REFERENCES casos(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS case_legal_sources (
    ...
    fecha DATE,
    url_verificada TEXT,
    extracto_relevante TEXT,
    tema_juridico TEXT,
    nivel_confiabilidad TEXT,
    uso_en_documento BOOLEAN NOT NULL DEFAULT FALSE,
    payload JSONB NOT NULL DEFAULT '{}'::JSONB,
    created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE INDEX IF NOT EXISTS idx_casos_case_route ON casos(case_route);
...
CREATE INDEX IF NOT EXISTS idx_case_stage_outputs_case_id ON case_stage_outputs(case_id);
CREATE INDEX IF NOT EXISTS idx_case_pending_questions_case_id ON case_pending_questions(case_id);
CREATE INDEX IF NOT EXISTS idx_case_legal_sources_case_id ON case_legal_sources(case_id);
